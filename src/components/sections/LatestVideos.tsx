  ...
  return (
    <div className="text-white py-20 font-gilroy">
      <div className="container mx-auto px-4">
        ...
        {/* Wrapper with gradient border only on left and right */}
        <div className="relative rounded-3xl overflow-hidden">
          {/* Left gradient border */}
          <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-pink-500 via-purple-500 to-blue-500 blur-sm opacity-70"></div>

          {/* Right gradient border */}
          <div className="absolute right-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-pink-500 via-purple-500 to-blue-500 blur-sm opacity-70"></div>

          {/* Actual Grid Content with website background */}
              ...
              {videos.map((video, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3
                        className="text-lg font-semibold mb-4 h-20 overflow-hidden"
                        style={{ fontFamily: 'Gilroy', fontWeight: 600 }}
                      >
                        {video.title}
                      </h3>
