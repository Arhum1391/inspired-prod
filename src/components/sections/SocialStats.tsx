    ...
    <section className="relative z-10 px-2 sm:px-3 md:px-4 lg:px-6 py-12 sm:py-16 md:py-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          {/* First Row - 5 stats */}
          <div
            className="flex flex-wrap justify-center items-start gap-4 sm:gap-8 lg:gap-12 w-full max-w-5xl"
            style={{
              display: 'flex',
          ...
          >
            ...
            {/* Vertical divider */}
            <div
              className="hidden sm:block w-px h-8 sm:h-12 lg:h-16"
              style={{
          ...
          <div
            className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 lg:gap-12 w-full max-w-4xl"
            style={{
              display: 'flex',
              justifyContent: 'center',
              alignItems: 'center',
