  ...
  return (
    <section className="relative z-[1] px-2 sm:px-3 md:px-4 lg:px-6 py-12 sm:py-16 md:py-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div
          className="flex flex-col items-center gap-8 sm:gap-16 lg:gap-32"
          style={{
            display: 'flex',
        ...
        >
          {/* First Row - 5 stats */}
          <div
            className="flex flex-wrap justify-center items-start gap-2 sm:gap-8 lg:gap-12 w-full max-w-5xl"
            style={{
              display: 'flex',
          ...
          >
            ...
            >
              {/* TikTok Icon */}
              <svg className="w-5 h-5 sm:w-8 sm:h-8" viewBox="0 0 24 24" fill="white">
                <path d="M12.53.02C13.84 0 15.14.01 16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
              </svg>
              <div
                className="text-lg sm:text-2xl lg:text-3xl text-center text-white"
                style={{
                  fontFamily: 'Gilroy',
                  fontWeight: 600,
            ...
            {/* Vertical divider */}
            <div
              className="w-px h-8 sm:h-12 lg:h-16"
              style={{
                background: 'radial-gradient(110.06% 87.69% at 50% 50.19%, rgba(255, 255, 255, 0.6) 0%, rgba(10, 10, 10, 0) 100%)'
              }}
            ></div>
            ...
            >
              {/* Instagram Icon */}
              <svg className="w-5 h-5 sm:w-8 sm:h-8" fill="white" viewBox="0 0 24 24">
          ...
          <div
            className="flex flex-wrap justify-center items-center gap-2 sm:gap-8 lg:gap-12 w-full max-w-4xl"
            style={{
              display: 'flex',
              justifyContent: 'center',
              alignItems: 'center',
          ...
          >
            ...
            >
              {/* Threads Icon */}
              <img
                src="/social logos/Threads--Streamline-Bootstrap.svg"
                alt="Threads"
