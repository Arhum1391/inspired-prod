      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-2 md:mt-0">
          ...
          <ul className="space-y-1">
            <li><Link href="/#about"><span className="text-gray-300 hover:text-white transition-colors duration-200">Research</span></Link></li>
            <li><Link href="/#social-stats"><span className="text-gray-300 hover:text-white transition-colors duration-200">Calculator</span></Link></li>
            <li><Link href="/#latest-videos"><span className="text-gray-300 hover:text-white transition-colors duration-200">Portfolio</span></Link></li>
            <li><Link href="/#partners"><span className="text-gray-300 hover:text-white transition-colors duration-200">Shariah</span></Link></li>
            <li><Link href="/#collaboration"><span className="text-gray-300 hover:text-white transition-colors duration-200">Our Team</span></Link></li>
