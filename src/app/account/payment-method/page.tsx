                    ...
                    >
                      ...
                      >
                        <input
                          ...
                          className="w-full bg-transparent border-none outline-none text-white/30 gilroy-medium"
                          style={{
                            fontFamily: 'Gilroy-Medium',
                            fontStyle: 'normal',
                            fontWeight: 400,
                      ...
                      >
                        ...
                        >
                          <input
                            ...
                            placeholder="MM/YY"
                            className="w-full bg-transparent border-none outline-none text-white/30 gilroy-medium min-w-0"
                            style={{
                              fontFamily: 'Gilroy-Medium',
                              fontStyle: 'normal',
                              fontWeight: 400,
