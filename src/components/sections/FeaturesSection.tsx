...
const FeatureCard: React.FC<FeatureCardProps> = ({ href, icon, title, description, index }) => {
  return (
    <Link href={href} className="cursor-pointer bg-[#1F1F1F]/80 p-6 rounded-2xl border-2 border-transparent hover:border-gray-400/30 transition-all duration-300 w-full relative overflow-hidden group backdrop-blur-sm">
