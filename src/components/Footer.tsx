      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex space-x-3 relative z-30 pr-5">
            ...
            <Link href="instagram.com/inspiredanalyst/" target="_blank" rel="noopener noreferrer">
              <div className="social-icon-box">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative z-20 mt-12 pt-8 border-t border-gray-600">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 sm:mt-0">
                ...
                <Link href="/terms"><span className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Terms of Service</span></Link>
              </div>
            </div>
          </div>
        </footer>
